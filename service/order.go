...
type OrderService interface {
	...
	DeleteOrder(orderId int) (*dto.GetDeleteResponse, errs.Error)
}
...
func (os *orderService) DeleteOrder(orderId int) (*dto.GetDeleteResponse, errs.Error) {
	err := os.OrderRepo.DeleteOrder(orderId)

	if err != nil {
		return nil, err
	}
	response := dto.GetDeleteResponse{
